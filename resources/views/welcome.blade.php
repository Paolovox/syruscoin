...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>SYRUS COIN | Home page</title>
        ...
        <link rel="stylesheet" href="theme/assets/css/fontello.css">
        <link href="theme/assets/fonts/icon-7-stroke/css/pe-icon-7-stroke.css" rel="stylesheet">
        <link href="theme/assets/fonts/icon-7-stroke/css/helper.css" rel="stylesheet">
        <link href="theme/assets/css/animate.css" rel="stylesheet" media="screen">
        <link rel="stylesheet" href="theme/assets/css/bootstrap-select.min.css">
        <link rel="stylesheet" href="theme/bootstrap/css/bootstrap.min.css">
        <link rel="stylesheet" href="theme/assets/css/icheck.min_all.css">
        <link rel="stylesheet" href="theme/assets/css/price-range.css">
    ...
    <body>
                    ...
                    <div class="col-md-5 col-sm-8  col-xs-12">
                        <div class="header-half header-call">
                            <p>
                                ...
                                <span><i class="pe-7s-mail"></i> info@syrusindustry.com  </span>
                            </p>
                        </div>
                    </div>
        ...
        <nav class="navbar navbar-default ">
            <div class="container">
                ...
                <div class="navbar-header" style="margin-top:-2.4%">
...
<!--
                        ...
                        <li class="wow fadeInDown" data-wow-delay="0.5s"><a href="#">Contatti</a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                            <div class="single-footer">
                                ...
                                <img src="theme/assets/img/footer-logo.png" alt="" class="wow pulse" data-wow-delay="1s">
                            ...
                            <div class="single-footer">
                                ...
                                <ul class="footer-blog">
                                    <li>
                                        <div class="col-md-3 col-sm-4 col-xs-4 blg-thumb p0">
                                            <a href="single.html">
                                                <img src="theme/assets/img/demo/small-proerty-2.jpg">
                                            </a>
        ...
        <script src="theme/assets/js/modernizr-2.6.2.min.js"></script>
        ...
        <script src="theme/assets/js/bootstrap-hover-dropdown.js"></script>

        <script src="theme/assets/js/easypiechart.min.js"></script>
        <script src="theme/assets/js/jquery.easypiechart.min.js"></script>

        <script src="theme/assets/js/owl.carousel.min.js"></script>
        <script src="theme/assets/js/wow.js"></script>

        <script src="theme/assets/js/icheck.min.js"></script>
